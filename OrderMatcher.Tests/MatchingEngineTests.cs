...
namespace OrderMatcher.Tests
{
    public class MatchingEngineTests
    {
        ...
        public MatchingEngineTests()
        {
            ...
            matchingEngine = new SimpleMatchingEngine(null, mockTradeListener.Object, mockFeeProcider.Object, 1, 2);
        }
        ...
        {
            SimpleMatchingEngine matchingEngine = new SimpleMatchingEngine(null, mockTradeListener.Object, mockFeeProcider.Object, 1, 0);
            Order order1 = new Order { IsBuy = true, OrderId = 1, OpenQuantity = 1000, Price = 10 };
            matchingEngine.AddOrder(order1, 1);
        ...
        {
            var matchingEngine = new SimpleMatchingEngine(null, mockTradeListener.Object, mockFeeProcider.Object, 1, 0);
            Order order1 = new Order { IsBuy = false, OpenQuantity = 500, Price = 10, OrderId = 1 };
            OrderMatchingResult acceptanceResult = matchingEngine.AddOrder(order1, 1);
        ...
        {
            matchingEngine = new SimpleMatchingEngine(null, mockTradeListener.Object, mockFeeProcider.Object, 0.5m, 0);
        ...
        {
            matchingEngine = new SimpleMatchingEngine(null, mockTradeListener.Object, mockFeeProcider.Object, 3, 0);
            Order order1 = new Order { IsBuy = true, OrderId = 1, OpenQuantity = 1000, Price = 10 };
            OrderMatchingResult accepted = matchingEngine.AddOrder(order1, 1);
            Assert.Equal(OrderMatchingResult.QuantityAndTotalQuantityShouldBeMultipleOfStepSize, accepted);
            Assert.DoesNotContain(order1.OrderId, matchingEngine.AcceptedOrders);
        ...
        {
            matchingEngine = new SimpleMatchingEngine(null, null, mockFeeProcider.Object, 1, 0);
        ...
        {
            matchingEngine = new SimpleMatchingEngine(null, mockTradeListener.Object, mockFeeProcider.Object, 0.0000_0001m, 2);
